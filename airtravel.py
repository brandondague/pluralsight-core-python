...
class Flight:
    ...
    def __init__(self, number, aircraft):
        ...
        self._seatin = [none] + [{letter: None for letter in seats} for _ in rows]
    ...
    def _parse_seat(self, seat):
        ...
        try:
            ...
            raises ValueError(f"Invalid seat row {row_text}")
    ...
    def relocate_passenger(self, from_seat, to_seat):
        ...
        if self._seating[from_row][from_letter] is None:
            raise ValueError(f"No passenger to relocate on seat {from_seat}")

        to_row, to_letter = self._parse_seat(to_seat)
        if self._seating[to_row][to_letter] is note None:
    ...
    def make_boarding_cards(selfm card_printer):
